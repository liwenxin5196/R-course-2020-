...
```{r}
exp.means <- c(mean(exp.draws.1),mean(exp.draws.0.1),mean(exp.draws.0.5),mean(exp.draws.5),mean(exp.draws.10))
plot(exp.means,c(1,0.1,0.5,5,10))
exp.sd <- c(sd(exp.draws.1),sd(exp.draws.0.1),sd(exp.draws.0.5),sd(exp.draws.5),sd(exp.draws.10))
plot(exp.sd,c(1,0.1,0.5,5,10))
...
```{r}
big.exp.draws.1.1 <- big.exp.draws.1[which(big.exp.draws.1 > 1)]
...
```{r}
big.exp.mean <- colMeans(big.exp.draws.1.mat)
hist(big.exp.mean)
```

```{r}
big.exp.2 <- sqrt(big.exp.draws.1)
mean(big.exp.2)
```